...
class RecusarPagamentoUseCaseTest {
    ...
    fun setUp() {
        ...
        useCase = RecusarPagamentoUseCase(pagamentoRepository, pedidoRepository)
    }

    @Test
    fun `deve reprovar pagamento e publicar evento`() {
        ...
        every { pedidoRepository.updateStatus(pedidoId.toString(), "PAGAMENTO_RECUSADO") } answers { }
